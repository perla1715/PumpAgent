"""Shared helpers for Live Data immutable domain contracts."""
...
class FrozenDict(Mapping):
    """Immutable mapping used for nested Live Data payloads."""
...
class SerializableMixin:
    """Mixin for converting Live Data contracts to primitive dictionaries."""
